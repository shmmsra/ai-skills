...
This directory holds the architectural decisions for ai-skills. Every significant design choice that another agent might wonder about — *"why is this done this way?"* — should be recorded here.
